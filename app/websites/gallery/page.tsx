  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white overflow-x-hidden">
      ...
      <header className="fixed top-0 left-0 right-0 z-40 py-4 px-6 backdrop-blur-sm bg-black/30">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <div className="flex items-center space-x-6">
            ...
            {/* Admin mode indicator - only visible to admin */}
            {adminMode && (
              <div className="flex items-center space-x-2">
                <span className="text-xs text-purple-300">Curator Mode</span>
      ...
      >
        ...
        {/* Curator controls - only visible to admin */}
        {adminMode && (
            ...
            {ARTWORKS.map((artwork) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    {/* Admin upload button - only visible to admin */}
                    {adminMode && (
